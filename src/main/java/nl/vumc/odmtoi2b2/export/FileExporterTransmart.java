...
public class FileExporterTransmart implements FileExporter {
     ...
     */
    private static final Logger logger = LoggerFactory.getLogger(FileExporterTransmart.class);
     ...
     */
    public FileExporterTransmart(final String exportFilePath, final String studyName, final Configuration configuration)
            throws IOException {
